					...
					<div
						...
						<div class="room-content">
							...
							<div class="room-feature" style="margin-bottom: 0px;">
								...
								<span>
									Đặt onl chỉ với :  <span style="color: red;">${defines.formatNumber(room.prepayment*room.price*0.01)} VND</span>
								</span>
							</div>
							<a
				...
				<div class="hotel-reservation--area mb-100">
					<form
						...
						<div class="form-group mb-30">
							<label for="checkInDate">Thời gian</label>
							<div class="input-daterange" id="datepicker">
								<div class="row no-gutters">
									<div class="col-6">
										<input type="text" class="input-small form-control"
											id="checkInDate" name="checkin" placeholder="Ngày nhận phòng">
									</div>
									<div class="col-6">
										<input type="text" class="input-small form-control"
											name="checkout" placeholder="Ngày trả phòng">
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row">
								<div class="col-6">
									<select name="adults" id="guests" class="form-control">
										<option value="00">Người lớn</option>
										<option value="01"
						...
						<div class="form-group mb-30">
							<label for="guests">Giá tiền (VND/Ngày)</label>
							<div class="row">
								<div class="col-6">
