					...
					<div
						...
						<div class="room-content">
							...
							<div class="room-feature" style="margin-bottom: 0px;">
								...
								<span> Đặt onl chỉ với : <span style="color: red;">${defines.formatNumber(room.prepayment*room.price*0.01)}
										VND</span>
								</span>
							</div>
							<a
							...
							<div class="row">
								<div class="col-6">
									<input type="date" class="form-control" id="checkin"
										name="checkin" style="width: 350px;" value="${check.checkin}">
								</div>
							</div>
							<div class="row">
								<div class="col-6">
									<input type="date" class="form-control" id="checkin"
										name="checkout" style="width: 350px; margin-top: 30px;"
										value="${check.checkout}">
								</div>
							</div>
						</div>
						<div class="form-group mb-30">
