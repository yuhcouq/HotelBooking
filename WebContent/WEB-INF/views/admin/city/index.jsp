				...
				<div class="sparkline13-list">
					<div class="sparkline13-graph">
						...
						<div class="datatable-dashv1-list custom-datatable-overright">
							<div class="row">
								<a href="${pageContext.request.contextPath }/admin/city/add"
							...
							<table id="table" data-toggle="table" data-pagination="true"
								...
								<thead class="text-align">
									<tr>
										...
										<th class="table-image">Country</th>
										<th class="table-image">Function</th>
									</tr>
								</thead>
								<tbody class="text-align">
									...
									<c:forEach items="${listCities}" var="city">
										<c:set var="editUrl"
											value="${pageContext.request.contextPath }/admin/city/edit/${city.id_city}"></c:set>
										<c:set var="delUrl"
											value="${pageContext.request.contextPath }/admin/city/del/${city.id_city}"></c:set>
										<c:set var="STT" value="${STT + 1}"></c:set>
										<tr>
											<td><p>${STT}</p></td>
											<td><p>${city.city_name}</p></td>
